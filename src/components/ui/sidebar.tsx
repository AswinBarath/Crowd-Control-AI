...
>(
  (
    ...
    return (
      <aside
          ref={ref}
          className={cn("group hidden md:fixed md:inset-y-0 md:z-50 md:flex md:flex-col text-sidebar-foreground bg-sidebar transition-all duration-300 ease-in-out",
